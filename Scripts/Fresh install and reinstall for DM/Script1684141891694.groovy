...
WebUI.navigateToUrl('https://apps.shopify.com/discount-manager?ot=251891bd-66fd-48f3-8f1f-efdd3da6ae14&search_id=b07172c6-4e29-45b6-819b-66fd87d66705&surface_detail=Discount+manager&surface_inter_position=1&surface_intra_position=2&surface_type=search_ad')
...
WebUI.click(findTestObject('Shopify Logged In/a_App Name of DM'))
...
WebUI.click(findTestObject('Shopify Logged In/span_Uninstall from apps and sales channel settings page for DM'))
