...
WebUI.navigateToUrl('https://apps.shopify.com/pre-order?search_id=57c43106-df28-4293-a6f4-19b59975a8aa&surface_detail=pre-order+manager&surface_inter_position=1&surface_intra_position=4&surface_type=search')
...
WebUI.click(findTestObject('Shopify Logged In/a_App Name of POM'))

WebUI.delay(15)

Actual_Url = WebUI.getUrl()

Expected_Url = (('https://fresh-install-' + getCurrentTimeStamp) + '.myshopify.com/admin/apps/pre-order/admin/detect-theme')
...
WebUI.click(findTestObject('Shopify Logged In/span_Uninstall from apps and sales channel settings page for POM'))
